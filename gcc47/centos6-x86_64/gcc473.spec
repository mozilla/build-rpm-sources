...
%changelog
* Thu Aug 1 2013 Rail Aliiev <rail@mozilla.com>
- New gcc upstream version (4.7.3)
- New mpfr upstream version (3.1.2)
- New gmp upstream version (5.1.2)
